...
void main(void) {
    ...
    while(1) {
        ...
        GPIObits.GP0 = 0; GPIObits.GP1 = 1; GPIObits.GP4 = 1; GPIObits.GP5 = 1;
        variable_delay(delay_ms);


        GPIObits.GP0 = 1; GPIObits.GP1 = 0; GPIObits.GP4 = 1; GPIObits.GP5 = 1;
        variable_delay(delay_ms);


        GPIObits.GP0 = 1; GPIObits.GP1 = 1; GPIObits.GP4 = 0; GPIObits.GP5 = 1;
        variable_delay(delay_ms);


        GPIObits.GP0 = 1; GPIObits.GP1 = 1; GPIObits.GP4 = 1; GPIObits.GP5 = 0;
        variable_delay(delay_ms);
    }
